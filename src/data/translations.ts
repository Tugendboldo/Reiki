...
export const translations = {
  de: {
    ...
    hero: {
      ...
      description: 'Hier begleite ich persönliche Entwicklungsprozesse und Ausbildungen durch Reiki Usui Tibetano, Praktiken des traditionellen japanischen Reiki sowie durch erfahrungsbasierte Angebote, die dazu einladen, wieder in Kontakt mit dem Körper, der Präsenz und der inneren Wahrnehmung zu kommen.',
    ...
    approach: {
      badge: 'Mein Ansatz',
      title: ' ',
      titleHighlight: 'Hallo, schön dass du hier bist.',
      intro: 'Ich bin Erika Yuliana Castro.',
      introDescription: 'Ich begleite Menschen auf ihrem Weg zurück zu sich selbst – durch Reiki, Körperarbeit und ein tiefes Lauschen auf das, was Körper und Energie zu sagen haben.',
      introDescription2: 'Denn ich glaube: Heilung lässt sich nicht erzwingen. Sie zeigt sich von selbst – in dem Moment, in dem sich dein Körper sicher, gehalten und wirklich präsent fühlt.',
      philosophyTitle: 'Meine Philosophie',
      philosophy: 'Meine Arbeit basiert auf Reiki Usui Tibetano sowie auf dem traditionellen japanischen Reiki und folgt einem integrativen Verständnis von Körper, Energie und emotionalen Prozessen. Ich verstehe Heilung als einen natürlichen Vorgang, der nicht erzwungen werden kann, sondern sich entfaltet, wenn der Körper Sicherheit, Ruhe und Präsenz erfährt.',
      ...
      training: 'Darüber hinaus habe ich mich im traditionellen japanischen Reiki (Gendai Reiki Ho) sowie in ergänzenden ganzheitlichen Ansätzen weitergebildet, unter anderem in integrativer Frauenpsychologie und körper- und emotionsorientierter Arbeit. Diese Elemente fließen achtsam in Gruppen- und Erfahrungsräume ein und haben keinen ausbildenden oder zertifizierenden Charakter.',
    ...
    about: {
      ...
      closingText: 'Wenn du spürst, dass es Zeit ist, innezuhalten und dich selbst wieder klarer zu sehen: Ich lade dich ein, diesen Moment für dich zu nutzen.',
      closingText2: 'Schreib mir einfach – ich freue mich, dich kennenzulernen!',
    ...
    serviceDetails: {
      bioenergetischeMassage: {
        title: 'Bioenergetische Massage',
        subtitle: 'Tiefe Entspannung und ganzheitliche Balance',
        intro1: 'Die bioenergetische Massage ist eine Erfahrung der körperlichen Begleitung, die sanfte Massage mit natürlichen Ölen und bewusste Energiearbeit verbindet, um tiefe Entspannung und ganzheitliche Balance des Körpers zu fördern.',
        intro2: 'Durch respektvolle Berührung und achtsame Präsenz werden Reflexzonen, Energiemeridiane und der natürliche Fluss der Lebensenergie stimuliert. Die Behandlung begleitet den Körper dabei, Spannungen loszulassen, die Durchblutung zu aktivieren und natürliche Regulations- und Ruheprozesse zu fördern.',
        intro3: 'Während der Sitzung wird am energetischen Gleichgewicht (Chakren und Energiefeld) sowie an der Aktivierung des Lymphsystems und des Bindegewebes gearbeitet, sodass der Körper angesammelte Belastungen progressiv und sanft freisetzen kann.',
        howItWorks: 'Wie wirkt die bioenergetische Massage?',
        howItWorksIntro: 'Dieser Ansatz wirkt ganzheitlich und integrierend, indem er den Körper auf verschiedenen Ebenen begleitet:',
        benefitsList: [
          'fördert die Entspannung des Nervensystems',
          'verbessert die Blut- und Lymphzirkulation',
          'hilft, muskuläre Spannungen und Bindegewebsverspannungen zu lösen',
          'begleitet das Gleichgewicht des Hormon- und Immunsystems',
          'fördert ein allgemeines Gefühl von Ruhe, Klarheit und Wohlbefinden'
        ],
        benefitsClosing: 'Die Massage zielt nicht darauf ab, Veränderungen zu erzwingen, sondern die Bedingungen zu schaffen, damit der Körper sein natürliches Gleichgewicht und seinen Energiefluss wiederherstellen kann.',
        usefulFor: 'Wofür kann sie nützlich sein?',
        usefulForIntro: 'Die bioenergetische Massage kann verschiedene Momente und Bedürfnisse begleiten, zum Beispiel:',
        usefulForList: [
          'Zustände von Stress, Nervosität und Erschöpfung',
          'Schwierigkeiten beim Entspannen oder Einschlafen',
          'Muskelverspannungen, Körperschmerzen und Steifheit',
          'Beschwerden im Zusammenhang mit körperlicher oder emotionaler Ermüdung',
          'Erholungs- und Ruheprozesse (Rehabilitation, postoperativ, mit ärztlicher Indikation)',
          'Menstruationsbeschwerden und Wechseljahrsbeschwerden',
          'Schweregefühl in den Beinen oder körperliche Ermüdung',
          'Bedürfnis nach mentaler Klarheit, Ruhe und innerer Stabilität'
        ],
        usefulForClosing: 'Sie kann auch eine Unterstützung für Menschen sein, die ihr allgemeines Wohlbefinden verbessern, sich präsenter in ihrem Körper fühlen und ein Gefühl von Gleichgewicht und Vitalität wiedererlangen möchten.',
        approach: 'Ein respektvoller und bewusster Ansatz',
        approachText1: 'Jede Sitzung wird an die Bedürfnisse und den Moment jeder Person angepasst. Die Massage wird aus einer ethischen, sorgfältigen und nicht-invasiven Perspektive angeboten, die Grenzen, Rhythmen und persönliche Erfahrungen respektiert.',
      ...
      reiki: {
        ...
        subtitle: 'Begleitung in Präsenz - für tiefe Entspannung und innere Balance',
        ...
        sessionTitle: 'Reiki-Sitzungen',
        sessionDuration: 'Dauer: 30 Min. / 45–60 Min.',
        sessionContact: 'Mit oder ohne Berührung',
        sessionMusic: 'Leise Musik oder in Stille',
        sessionAroma: 'Aromatherapie und Kristalle (optional)',
        sessionButton: 'Sitzung buchen',
        sessionClosing: 'Wenn du gerade eine Zeit der Erschöpfung, des Stresses oder des Bedürfnisses nach Wiederverbindung durchläufst, kann eine Reiki-Sitzung ein erster Schritt sein, um zu deiner Mitte zurückzukehren. Buche deine Sitzung oder schreibe mir, um Fragen zu klären.',
      ...
      kristalltherapie: {
        title: 'Gruppenangebote',
        subtitle: 'Räume für gemeinsame Heilung, bewusste Praxis und tiefe Erforschung',
        intro: 'Die Gruppenangebote von Erika Natural Healing sind Räume für geteilte Heilung, bewusste Praxis und tiefe Erforschung.',
        intro2: 'Sie sind geschaffen, um echte Prozesse aus dem Körper, der Energie und der gelebten Erfahrung zu begleiten, und respektieren dabei den Rhythmus und Moment jedes Einzelnen.',
        practiceToHold: 'Praxis zum Halten.',
        explorationToOpen: 'Erforschung zum Öffnen.',
        integrationToTransform: 'Integration zum Transformieren.',
        circleName: 'Kreis von Licht und Heilung',
        circleIntro: 'ist ein monatliches Treffen für bewusste Reiki-Praxis, offen für Reiki-Praktizierende aller Stufen und auch für Menschen, die Reiki empfangen oder zum ersten Mal kennenlernen möchten.',
        noExperienceNeeded: 'Es ist keine Vorerfahrung erforderlich: Alle Menschen sind willkommen.',
        rootedIn: 'Dieser Raum entspringt dem traditionellen japanischen Reiki und der Erfahrungspraxis.',
        notFromMind: 'Hier kommt man nicht, um vom Verstand zu lernen, sondern um sich vom Körper, der Atmung und der Präsenz her zu erinnern.',
        duringMeetings: 'Während dieser Treffen führen wir durch:',
        practicesList: [
          'traditionelle Reiki-Praktiken (Hatsurei Ho, Kenyoku, Gassho)',
          'geführte Meditationen und Praktiken der inneren Verbindung',
          'Übungen für bewusste Atmung',
          'Gruppen-Reiki, Reiki-Gitter und Selbstanwendung',
          'Praktiken der Reinigung, des Zuhörens und der bewussten Präsenz'
        ],
        groupEnergy: 'Die Energie, die in der Gruppe entsteht, ist zutiefst transformierend.',
        whenWeTogether: 'Wenn wir gemeinsam heilen, dehnt sich die Schwingung aus, das Herz öffnet sich und der Prozess jedes Einzelnen wird von der liebevollen Kraft der Gruppe getragen.',
        invitation: 'Diese Treffen sind eine Einladung, dir eine heilige Zeit zu schenken, zu deinem Zentrum zurückzukehren und dich daran zu erinnern, dass du auf deinem Heilungsweg nicht allein bist.',
        contactText: 'Wenn du den Ruf spürst, schreibe mir für weitere Informationen oder um deinen Platz zu reservieren.',
      ...
      fortbildungskurse: {
        title: 'Ausbildungen im Usui-Tibetischen Reiki',
        ...
        certificationTitle: 'Qualifikation',
        certificationText: 'Ich bin Reiki-Meisterin im Usui-Tibetischen Reiki, anerkannt und federiert bei der Asociación Española de Reiki, und berechtigt, alle Ausbildungsstufen bis zur Meisterschaft mit Einweihung und Zertifizierung anzubieten.',

        approachTitle: 'Mein Ausbildungsansatz',
        approachIntro: 'In meinen Ausbildungen steht die direkte Erfahrung im Mittelpunkt. Reiki wird nicht als Technik vermittelt, sondern als gelebte Praxis, die den Alltag begleiten und vertiefen kann.',
        approachIncludes: 'Die Ausbildung umfasst:',
        approachList: [
          'regelmäßige Praxis des Gebens und Empfangens von Reiki',
          'Atem-, Präsenz- und Meditationsübungen aus dem traditionellen japanischen Reiki',
          'achtsames Arbeiten mit dem Körper',
          'Raum für Integration und Nachbegleitung'
        ],
        approachClosing: 'Es geht nicht darum, Grade zu sammeln, sondern eine stabile, authentische und nachhaltige Reiki-Praxis zu entwickeln.',

        formatsTitle: 'Ausbildungsformate',
        formatsIntro: 'Die Reiki-Ausbildungen werden sowohl in Präsenz als auch online (live) angeboten. In beiden Formaten lege ich großen Wert auf persönliche Begleitung, klare Struktur und eine ethisch verantwortungsvolle Übertragung.',
        inPersonTitle: 'Präsenzformat',
        inPersonDesc: 'Ausbildung in einem geschützten Raum mit direkter Praxis, Austausch und persönlicher Begleitung.',
        onlineTitle: 'Online-Format (live)',
        onlineDesc: 'Ausbildung in Echtzeit mit angeleiteter Praxis, Raum für Fragen und individuelle Begleitung.',
        initiationNote: 'Die Einweihungen erfolgen bewusst und entsprechend der Reiki-Tradition.',
        formatsInclude: 'Beide Formate beinhalten:',
        formatsIncludeList: [
          'Einweihungen (21 Tage nach der Einweihung besteht die Möglichkeit einer Wiedereinweihung, um den inneren Prozess behutsam weiter zu vertiefen)',
          'ausführliche Ausbildungsunterlagen',
          'offizielle Zertifizierung',
          'Begleitung nach Abschluss der Ausbildung'
        ],

        levelsTitle: 'Die Ausbildungsstufen',

        grade1: {
          title: 'Reiki Grad I – Shoden',
          subtitle: 'Grundlage und Einstieg',
          description: 'Der erste Grad bildet die Basis der Reiki-Praxis. Der Fokus liegt auf Selbstbehandlung, Körperwahrnehmung und der bewussten Integration von Reiki in den Alltag.',
          learnTitle: 'In dieser Stufe lernst du:',
          learnList: [
            'dich mit der Reiki-Energie zu verbinden',
            'die Selbstbehandlung anzuwenden',
            'Reiki an andere weiterzugeben',
            'grundlegende Handpositionen',
            'die Prinzipien von Reiki praktisch zu leben'
          ],
          availability: 'Verfügbar in Präsenz und online.'
        },

        grade2: {
          title: 'Reiki Grad II – Okuden',
          subtitle: 'Vertiefung und Ausrichtung',
          description: 'Der zweite Grad erweitert die Praxis und ermöglicht ein gezielteres Arbeiten mit Reiki. Die Aufmerksamkeit richtet sich stärker auf innere Klarheit, Fokus und Kontinuität.',
          contentsTitle: 'Inhalte dieses Grades sind unter anderem:',
          contentsList: [
            'Arbeit mit den Reiki-Symbolen',
            'Reiki-Anwendungen über die Distanz',
            'Begleitung von Prozessen und Situationen',
        ...
        grade3: {
          title: 'Reiki Grad III – Shinpiden',
          subtitle: 'Integration und innere Reife',
          description: 'Der dritte Grad unterstützt die tiefe Integration von Reiki als persönlichen Weg. Er richtet sich an Menschen, die ihre Praxis festigen und Reiki als Teil ihres Lebensverständnisses vertiefen möchten.',
          supportsTitle: 'Dieser Grad fördert:',
          supportsList: [
            'die Reifung der eigenen Praxis',
            'eine klare innere Ausrichtung',
            'die Verbindung von Reiki, Alltag und Bewusstsein'
          ],
          availability: 'Verfügbar in Präsenz und online.'
        },

        mastery: {
          title: 'Reiki-Meisterschaft Usui-Tibetisch',
          description: 'Die Meisterschaft ist ein Weg der Verantwortung und der bewussten Weitergabe. Sie richtet sich an Menschen, die den Wunsch verspüren, Reiki zu unterrichten, Einweihungen zu geben und andere achtsam zu begleiten.',
          permission: 'Nach Abschluss der Meisterschaft besteht die Berechtigung, Reiki-Ausbildungen zu geben und Zertifizierungen im Usui-Tibetischen Reiki auszustellen, im Einklang mit der Tradition und ihrer ethischen Verantwortung.',
          format: 'Format nach individueller Absprache.'
        },

        suitableForTitle: 'Für wen ist diese Ausbildung geeignet?',
        suitableForIntro: 'Die Ausbildung richtet sich an:',
        suitableForList: [
          'Menschen, die Reiki kennenlernen möchten',
          'Personen, die eine bewusste Praxis der Selbstfürsorge suchen',
          'Therapeut:innen, die Reiki in ihre Arbeit integrieren möchten',
          'Menschen mit dem Wunsch, Reiki später weiterzugeben'
        ],
        suitableForNote: 'Vorkenntnisse sind nicht erforderlich.',

        invitationTitle: 'Einladung',
        invitationText: 'Wenn du spürst, dass Reiki dich anspricht – sei es für deine persönliche Entwicklung oder für einen professionellen Weg – begleite ich dich gerne auf diesem Weg.',
        invitationContact: 'Schreibe mir für Informationen zu kommenden Terminen, Formaten und Verfügbarkeit.',
      ...
      makrameeWorkshops: {
        ...
        description2: 'Es geht nicht darum, aus dem Verstand zu lernen, sondern zu erlauben, dass die Erfahrung spricht und die Bedingungen zu schaffen, damit jede Person Zugang zu ihren eigenen Erkenntnissen findet.',
        approachTitle: 'Eine integrative Begleitung',
        approachDesc: 'Meine Art der Begleitung stützt sich auf eine integrative Perspektive, die Reiki, Präsenzpraktiken, Ressourcen der integrativen Frauenpsychologie und traditionelle Praktiken der symbolischen und körperlichen Arbeit vereint.',
        approachDesc2: 'Das bedeutet, einen Raum zu schaffen, in dem Körper, Emotion und persönliche Erfahrung ohne Eile, ohne Urteil und ohne die Forderung nach sofortiger Veränderung gehört werden können.',
        approachDesc3: 'Ich arbeite nicht aus der Analyse oder Diagnose heraus. Ich begleite aus dem Zuhören, dem Halt und dem Verständnis innerer Prozesse heraus, wobei ich die Zeiträume und die Weisheit respektiere, die jede Person bereits in sich trägt.',
        approachDesc4: 'Wo es angemessen ist, werden Worte, Fragen oder Reflexionen integriert, die helfen, Sinn zu geben, innere Lasten zu erleichtern und den Prozess mit größerer Klarheit und Freundlichkeit zu begleiten, immer aus einem nicht-invasiven Ort heraus.',
        workshopsTitle: 'Wie entwickeln sich diese Workshops?',
        workshopsDesc: 'Die Treffen beinhalten körperliche, kreative und symbolische Ansätze, die auf intuitive Weise Zugang zur inneren Welt ermöglichen, ohne Analyse oder Interpretation.',
        workshopsDesc2: 'Durch den Körper, das Symbol und die direkte Erfahrung werden Integrationsprozesse ermöglicht, die auf natürliche Weise entstehen, wenn der Raum sicher ist und gut gehalten wird.',
        notForced: 'Nichts wird erzwungen.',
        safePath: 'Jede Person geht ihren eigenen Weg innerhalb eines sorgfältig gehaltenen und respektvollen Raumes.',
        focusTitle: 'Ein sensibler und integrativer Ansatz',
        focusSubtitle: 'Die Arbeit ist darauf ausgerichtet:',
        focusList: [
          'die Verbindung mit dem Körper zu fördern',
          'Räume des inneren Zuhörens zu öffnen',
          'das Entstehen von Intuition zu ermöglichen',
          'tiefe Verständnisse ohne Urteil oder Anforderung zu erleichtern'
        ],
        invitationTitle: 'Diese Workshops sind eine Einladung, die Kontrolle, die Selbstanforderung und die Rolle des "Wissen-Müssens" loszulassen, um sich einer freieren, authentischeren und präsenteren Erfahrung zu öffnen.',
        forWhomTitle: 'Für wen sind diese Räume?',
        forWhomDesc: 'Diese Treffen sind für Menschen gedacht, die den Ruf spüren:',
        forWhomList: [
          'ihre innere Welt zu erforschen',
          'ihren persönlichen Weg zu vertiefen',
          'neue Perspektiven aus der Erfahrung zu öffnen',
          'ihre Praxis aus einem erfahrungsbasierten Ansatz heraus zu nähren'
        ],
        noExperience: 'Es ist keine Vorerfahrung erforderlich.',
        onlyOpenness: 'Nur Offenheit, Neugier und Bereitschaft zu erforschen.',
        finalInvitationTitle: '✨ Einladung',
        ...
        finalInvitationCTA: 'Entdecke die kommenden Treffen und reserviere deinen Platz.',
  ...
  en: {
    ...
    hero: {
      ...
      description: 'Here I accompany personal development processes and training through Reiki Usui Tibetano, traditional Japanese Reiki practices, and experiential offerings that invite you to reconnect with the body, presence, and inner perception.',
      featuresHeading: 'All offerings arise from respect for individual rhythm. No processes are forced – rather, a protected space is created where healing can reveal itself when there is rest, openness, and trust.',
    ...
    approach: {
      ...
      introDescription: 'I accompany people on their journey back to themselves – through Reiki, bodywork, and a deep listening to what the body and energy have to say.',
      introDescription2: 'Because I believe healing can´t be forced. It reveals itself on its own – in the moment your body feels safe, held, and truly present.',
      philosophyTitle: 'My Philosophy',
      philosophy: 'My work is grounded in Usui Tibetan Reiki and traditional Japanese Reiki, following an integrative understanding of body, energy, and emotional processes. I understand healing as a natural process that cannot be forced, but unfolds when the body experiences safety, rest, and presence.',
      credentialsTitle: 'Credentials',
      credentials: 'I am a Reiki Master in Usui Tibetan Reiki, recognized and federated by the Spanish Reiki Association, and authorized to offer Reiki training, certify all levels, and train new Reiki Masters – always in harmony with tradition, professional ethics, and individual development processes.',
      trainingTitle: 'Further Training',
      training: 'Additionally, I have trained in traditional Japanese Reiki (Gendai Reiki Ho) as well as complementary holistic approaches, including integrative women\'s psychology and body- and emotion-oriented work. These elements flow mindfully into group and experiential spaces and have no training or certifying character.',
      ...
      vision: 'For me, Reiki is a living practice and a path of inner clarity, expressed in individual sessions, group offerings, and training – carried by simplicity, ethics, and transparency.',
      closing: 'If you’ve made it this far, perhaps your body is also asking for a space to rest and reconnect with itself. It will be my pleasure to accompany you whenever you feel ready.'
    },
    about: {
      badge: 'About Me',
      title: 'About ',
      titleHighlight: 'Me',
      description1: 'Maybe you know that feeling: a moment when everything suddenly stands still – and you sense that something within you wants to change. That´s how it was for me with Reiki, too. It never came into my life by chance, but always exactly when I needed it most – during phases of deep inner transformation and personal reorientation.',
      description2: 'For more than 12 years now, Reiki has accompanied me: in my own practice and in guiding others through theirs. It has always been a reliable companion – a presence that holds, brings order, and supports in a way that is loving, subtle, and deeply profound at once.',
      description3: 'My path led me through different teachers and approaches. It taught me that clarity doesn´t arrive as a sudden enlightenment, but as a slow, honest process – an unfiltered meeting with oneself, to recognize which parts of one´s life reflect inner truth, and which merely follow outside expectations.',
      description4: 'How I accompany you:',
      description5: 'I create spaces where nothing has to be fought – only heard. Spaces for pause, stillness, and presence, where what truly matters can find its own order again.',
      closingText: 'If you feel it´s time to pause and see yourself more clearly again: I invite you to take this moment for yourself.',
      closingText2: 'Just reach out – I´d love to get to know you!',
    ...
    serviceDetails: {
      bioenergetischeMassage: {
        title: 'Bioenergetic Massage',
        subtitle: 'Deep Relaxation and Holistic Balance',
        intro1: 'Bioenergetic massage is an experience of body accompaniment that combines gentle massage with natural oils and conscious energetic work, aimed at promoting deep relaxation and holistic balance of the body.',
        intro2: 'Through respectful contact and attentive presence, reflex zones, energy meridians, and the natural flow of vital energy are stimulated. The treatment accompanies the body to release tensions, activate circulation, and promote natural regulation and rest processes.',
        intro3: 'During the session, work is done on energetic rebalancing (chakras and energy field), as well as on the activation of the lymphatic system and connective tissue, allowing the body to release accumulated burdens progressively and gently.',
        howItWorks: 'How does bioenergetic massage work?',
        howItWorksIntro: 'This approach acts in a global and integrative way, accompanying the body on different levels:',
        benefitsList: [
          'promotes relaxation of the nervous system',
          'improves blood and lymph circulation',
          'helps release muscular tensions and connective tissue',
          'accompanies the balance of the hormonal and immune system',
          'promotes a general feeling of calm, clarity, and well-being'
        ],
        benefitsClosing: 'The massage does not seek to force changes, but to create the conditions for the body to recover its natural balance and energy flow.',
        usefulFor: 'What can it be useful for?',
        usefulForIntro: 'Bioenergetic massage can accompany different moments and needs, for example:',
        usefulForList: [
          'states of stress, nervousness, and exhaustion',
          'difficulties relaxing or falling asleep',
          'muscular tensions, body pain, and stiffness',
          'discomfort associated with physical or emotional fatigue',
          'recovery and rest processes (rehabilitation, postoperative, with medical indication)',
          'menstrual discomfort and menopause symptoms',
          'feeling of heaviness in legs or body fatigue',
          'need for mental clarity, calm, and inner stability'
        ],
        usefulForClosing: 'It can also be a support for people who want to improve their general well-being, feel more present in their body, and recover a sense of balance and vitality.',
        approach: 'A respectful and conscious approach',
        approachText1: 'Each session is adapted to the needs and moment of each person. The massage is offered from an ethical, careful, and non-invasive perspective, respecting boundaries, rhythms, and personal experience.',
      ...
      reiki: {
        title: 'Reiki sessions',
        subtitle: 'One-to-One support - aimed at deep relaxation and natural self-regulation of the system',
        ...
        sessionTitle: 'Reiki Sessions',
        sessionDuration: 'Duration: 30 min / 45–60 min',
        sessionContact: 'With or without touch',
        sessionMusic: 'Soft music or in silence',
        sessionAroma: 'Aromatherapy and crystals (optional)',
        sessionButton: 'Book your session',
        sessionClosing: 'If you are going through a time of fatigue, stress, or need for reconnection, a Reiki session can be a first step to return to your center. Book your session or write to me to resolve any questions.',
      ...
      kristalltherapie: {
        title: 'Group Gatherings',
        subtitle: 'Spaces for shared healing, conscious practice and deep exploration',
        intro: 'The group gatherings at Erika Natural Healing are spaces for shared healing, conscious practice and deep exploration.',
        intro2: 'They are created to accompany real processes from the body, energy and lived experience, respecting the rhythm and moment of each person.',
        practiceToHold: 'Practice to hold.',
        explorationToOpen: 'Exploration to open.',
        integrationToTransform: 'Integration to transform.',
        circleName: 'Circle of Light and Healing',
        circleIntro: 'is a monthly gathering for conscious Reiki practice, open to Reiki practitioners of all levels and also to people who wish to receive Reiki or experience it for the first time.',
        noExperienceNeeded: 'No previous experience is necessary: all people are welcome.',
        rootedIn: 'This space is rooted in traditional Japanese Reiki and experiential practice.',
        notFromMind: 'Here we do not come to learn from the mind, but to remember from the body, breath and presence.',
        duringMeetings: 'During these gatherings we engage in:',
        practicesList: [
          'traditional Reiki practices (Hatsurei Ho, Kenyoku, Gassho)',
          'guided meditations and inner connection practices',
          'conscious breathing exercises',
          'group Reiki, Reiki grid and self-application',
          'practices of purification, listening and conscious presence'
        ],
        groupEnergy: 'The energy generated in the group is deeply transformative.',
        whenWeTogether: 'When we heal together, the vibration expands, the heart opens and each person\'s process is held by the loving force of the group.',
        invitation: 'These gatherings are an invitation to gift yourself sacred time, return to your center and remember that you are not alone on your healing journey.',
        contactText: 'If you feel the call, write to me for more information or to reserve your place.',
      ...
      makrameeWorkshops: {
        ...
        description2: 'It is not about learning from the mind, but about allowing experience to speak, creating the conditions for each person to access their own understandings.',
        approachTitle: 'An integrative accompaniment',
        approachDesc: 'My way of accompanying is supported by an integrative perspective that brings together Reiki, presence practices, resources from integrative feminine psychology, and ancestral practices of symbolic and body work.',
        approachDesc2: 'This means creating a space where the body, emotion, and personal experience can be listened to without haste, without judgment, and without the demand for immediate change.',
        approachDesc3: 'I do not work from analysis or diagnosis. I accompany from listening, holding, and understanding internal processes, respecting the timing and wisdom that each person already carries.',
        approachDesc4: 'When appropriate, words, questions, or reflections are integrated that help to make sense, lighten the internal burden, and accompany the process with greater clarity and kindness, always from a non-invasive place.',
        workshopsTitle: 'How do these workshops unfold?',
        workshopsDesc: 'The gatherings include physical, creative, and symbolic proposals that allow access to the inner world in an intuitive way, without analysis or interpretation.',
        workshopsDesc2: 'Through the body, symbol, and direct experience, integration processes are enabled that arise naturally when the space is safe and well held.',
        notForced: 'Nothing is forced.',
        safePath: 'Each person walks their own path within a carefully held and respectful space.',
        focusTitle: 'A sensitive and integrative approach',
        focusSubtitle: 'The work is oriented to:',
        focusList: [
          'foster connection with the body',
          'open spaces for inner listening',
          'allow intuition to emerge',
          'facilitate deep understandings without judgment or demand'
        ],
        invitationTitle: 'These workshops are an invitation to release control, self-demand, and the role of "having to know," to open oneself to a freer, more authentic, and more present experience.',
        forWhomTitle: 'Who are these spaces for?',
        forWhomDesc: 'These gatherings are intended for people who feel called to:',
        forWhomList: [
        ...
        onlyOpenness: 'Only openness, curiosity, and willingness to explore.',
        finalInvitationTitle: '✨ Invitation',
        ...
        finalInvitationCTA: 'Discover upcoming gatherings and reserve your place.',
  ...
  es: {
    ...
    hero: {
      ...
      description: 'Aquí acompaño procesos personales y formativos a través del Reiki Usui Tibetano, prácticas de Reiki tradicional japonés y encuentros vivenciales que invitan a volver a la presencia, al cuerpo y a la escucha interna.',
      featuresHeading: 'Cada propuesta nace desde el respeto por el ritmo individual, sin forzar procesos, creando un espacio seguro donde la sanación se revela cuando hay descanso, apertura y confianza.',
    ...
    approach: {
      badge: 'Mi Enfoque',
      title: ' ',
      titleHighlight: 'Hola, qué bueno que estás aquí',
      intro: 'Soy Erika Yuliana Castro.',
      introDescription: 'Acompaño a las personas en su camino de regreso a sí mismas – a través del Reiki, el trabajo corporal y una escucha profunda de lo que el cuerpo y la energía tienen que decir.',
      introDescription2: 'Porque creo que la sanación no se puede forzar. Se manifiesta por sí sola – en el momento en que tu cuerpo se siente seguro, sostenido y verdaderamente presente.',
    ...
    about: {
      ...
      title: 'Sobre ',
      titleHighlight: 'mí',
      description1: 'Tal vez conoces ese momento: cuando de repente todo se detiene – y sientes que algo en ti quiere transformarse. Así fue también para mí con el Reiki. Nunca llegó a mi vida por casualidad, sino siempre justo cuando más lo necesitaba – en fases de profunda transformación interior y reorientación personal.',
      description2: 'Desde hace más de 12 años, el Reiki me acompaña: en mi propia práctica y en el acompañamiento de otras personas. Ha sido siempre un compañero confiable para mí – una presencia que sostiene, ordena y acompaña de una manera amorosa, sutil y a la vez profunda.',
      description3: 'Mi camino me llevó a través de distintos maestros y enfoques. Me enseñó que la claridad no surge como una iluminación repentina, sino como un proceso lento y honesto – un encuentro con uno mismo sin filtros, para reconocer qué partes de la propia vida responden a la verdad interior y cuáles solo siguen expectativas externas.',
      description4: 'Así te acompaño:',
      description5: 'Creo espacios en los que nada tiene que combatirse – sino que puede ser escuchado. Espacios para la pausa, el silencio y la presencia, donde lo esencial vuelve a ordenarse por sí solo.',
      closingText: 'Si sientes que es momento de detenerte y volver a verte con más claridad: te invito a aprovechar este momento para ti.',
      closingText2: 'Escríbeme, será un placer conocerte!',
    ...
    serviceDetails: {
      bioenergetischeMassage: {
        title: 'Masaje Bioenergético',
        subtitle: 'Relajación profunda y equilibrio integral',
        intro1: 'El masaje bioenergético es una experiencia de acompañamiento corporal que combina masaje suave con aceites naturales y trabajo energético consciente, orientada a favorecer la relajación profunda y el equilibrio integral del cuerpo.',
        intro2: 'A través de un contacto respetuoso y presencia atenta, se estimulan zonas reflejas, meridianos energéticos y el flujo natural de la energía vital. El tratamiento acompaña al cuerpo a soltar tensiones, activar la circulación y favorecer los procesos naturales de regulación y descanso.',
        intro3: 'Durante la sesión se trabaja el reequilibrio energético (chakras y campo energético), así como la activación del sistema linfático y del tejido conectivo, permitiendo que el cuerpo libere cargas acumuladas de forma progresiva y suave.',
        howItWorks: '¿Cómo actúa el masaje bioenergético?',
        howItWorksIntro: 'Este enfoque actúa de manera global e integradora, acompañando al cuerpo en distintos niveles:',
        benefitsList: [
          'favorece la relajación del sistema nervioso',
          'mejora la circulación sanguínea y linfática',
          'ayuda a liberar tensiones musculares y del tejido conectivo',
          'acompaña el equilibrio del sistema hormonal e inmunológico',
          'promueve una sensación general de calma, claridad y bienestar'
        ],
        benefitsClosing: 'El masaje no busca forzar cambios, sino crear las condiciones para que el cuerpo recupere su equilibrio natural y su flujo energético.',
        usefulFor: '¿Para qué puede ser útil?',
        usefulForIntro: 'El masaje bioenergético puede acompañar distintos momentos y necesidades, por ejemplo:',
        usefulForList: [
          'estados de estrés, nerviosismo y agotamiento',
          'dificultades para relajarse o conciliar el sueño',
          'tensiones musculares, dolores corporales y rigidez',
          'molestias asociadas al cansancio físico o emocional',
          'procesos de recuperación y descanso (rehabilitación, postoperatorios, con indicación médica)',
          'molestias menstruales y síntomas de la menopausia',
          'sensación de pesadez en piernas o cansancio corporal',
          'necesidad de claridad mental, calma y estabilidad interna'
        ],
        usefulForClosing: 'También puede ser un apoyo para personas que desean mejorar su bienestar general, sentirse más presentes en su cuerpo y recuperar una sensación de equilibrio y vitalidad.',
        approach: 'Un enfoque respetuoso y consciente',
        approachText1: 'Cada sesión se adapta a las necesidades y al momento de cada persona. El masaje se ofrece desde una mirada ética, cuidadosa y no invasiva, respetando los límites, los ritmos y la experiencia personal.',
      ...
      reiki: {
        title: 'Sesiones de Reiki ',
        subtitle: 'Acompañamiento desde la presencia, el cuerpo y la energía - orientadas al descanso profundo y a la autorregulación natural del sistema',
        ...
        sessionTitle: 'Sesiones de Reiki',
        sessionDuration: 'Duración: 30 min / 45–60 min',
        sessionContact: 'Con o sin contacto',
        sessionMusic: 'Música suave o en silencio',
        sessionAroma: 'Aromaterapia y cristales (opcional)',
        sessionButton: 'Agenda tu sesión',
        sessionClosing: 'Si estás atravesando un momento de cansancio, estrés o necesidad de reconexión, una sesión de Reiki puede ser un primer paso para volver a tu centro. Agenda tu sesión o escríbeme para resolver cualquier duda.',
        ...
        distanceTreatmentBenefits: [
          'El Reiki se aplica mediante una imposición de manos suave y consciente, con o sin contacto',
          'El tratamiento se acompaña de música suave, aromaterapia y cristales cuando es adecuado',
          'La sesión transcurre en silencio, sin interpretaciones ni diagnósticos',
          'Este es un tiempo para descansar, respirar y volver a sentirte en casa dentro de ti'
        ],
        reikiEffects: 'Beneficios del Reiki',
        reikiEffectsIntro: 'Reiki no trabaja solo sobre el cuerpo. Su efecto más profundo es devolverle a tu sistema la capacidad de autorregularse y encontrar calma donde antes había tensión. Muchas personas experimentan:',
        physicalLevel: 'A nivel más concreto',
        physicalBenefits: [
          'Una sensación real de descanso interno',
          'Liberación de cargas emocionales',
          'Mayor claridad mental y alivio del ruido interior',
          'Reactivación de la energía vital'
        ],
        emotionalLevel: 'Reiki puede ayudarte a',
        emotionalBenefits: [
          'Favorecer la liberación de tensiones internas',
          'Acompañar procesos emocionales',
          'Recuperar claridad y calma mental',
          'Sentirte más presente y conectada contigo misma'
        ],
        medicalDisclaimer: 'Reiki y la medicina tradicional',
        medicalDisclaimerText: [
          'Reiki no sustituye a la medicina convencional ni a ningún tratamiento médico.',
          'Es una terapia complementaria que acompaña los procesos de salud, ayudando a equilibrar el sistema energético y a activar los propios mecanismos de autosanación del cuerpo.',
          'Puede utilizarse junto a cualquier tratamiento médico, favoreciendo el bienestar general y ayudando a reducir los efectos del estrés, la ansiedad o el malestar emocional asociados a los procesos de enfermedad.',
          'Reiki siempre actúa para el mayor bien de la persona, respetando sus tiempos y su proceso personal.'
        ]
      },
      kristalltherapie: {
        title: 'Encuentros Grupales',
        subtitle: 'Espacios de sanación compartida, práctica consciente y exploración profunda',
        intro: 'Los encuentros grupales de Erika Natural Healing son espacios de sanación compartida, práctica consciente y exploración profunda.',
        intro2: 'Están creados para acompañar procesos reales desde el cuerpo, la energía y la experiencia vivida, respetando el ritmo y el momento de cada persona.',
        practiceToHold: 'Práctica para sostener.',
        explorationToOpen: 'Exploración para abrir.',
        integrationToTransform: 'Integración para transformar.',
        circleName: 'Círculo de Luz y Sanación',
        circleIntro: 'es un encuentro mensual de práctica consciente de Reiki, abierto a reikistas de todos los niveles y también a personas que desean recibir Reiki o conocerlo por primera vez.',
        noExperienceNeeded: 'No es necesario tener experiencia previa: todas las personas son bienvenidas.',
        rootedIn: 'Este espacio nace del Reiki tradicional japonés y de la práctica vivencial.',
        notFromMind: 'Aquí no se viene a aprender desde la mente, sino a recordar desde el cuerpo, la respiración y la presencia.',
        duringMeetings: 'Durante estos encuentros realizamos:',
        practicesList: [
          'prácticas tradicionales de Reiki (Hatsurei Ho, Kenyoku, Gassho)',
          'meditaciones guiadas y prácticas de conexión interior',
          'ejercicios de respiración consciente',
          'Reiki grupal, parrilla de Reiki y autoaplicación',
          'prácticas de purificación, escucha y presencia consciente'
        ],
        groupEnergy: 'La energía que se genera en grupo es profundamente transformadora.',
        whenWeTogether: 'Cuando sanamos junt@s, la vibración se expande, el corazón se abre y el proceso de cada persona se ve sostenido por la fuerza amorosa del grupo.',
        invitation: 'Estos encuentros son una invitación a regalarte un tiempo sagrado, volver a tu centro y recordar que no estás sola en tu camino de sanación.',
        contactText: 'Si sientes el llamado, escríbeme para recibir más información o reservar tu lugar.',
      ...
      makrameeWorkshops: {
        ...
        description2: 'No se trata de aprender desde la mente, sino de permitir que la experiencia hable, creando las condiciones para que cada persona acceda a sus propias comprensiones.',
        approachTitle: 'Un acompañamiento integrativo',
        approachDesc: 'Mi forma de acompañar se apoya en una mirada integrativa que une Reiki, prácticas de presencia, recursos de la psicología femenina integrativa y prácticas ancestrales de trabajo simbólico y corporal.',
        approachDesc2: 'Esto implica crear un espacio donde el cuerpo, la emoción y la experiencia personal puedan ser escuchados sin prisa, sin juicio y sin exigencia de cambio inmediato.',
        approachDesc3: 'No trabajo desde el análisis ni desde el diagnóstico. Acompaño desde la escucha, el sostén y la comprensión de los procesos internos, respetando los tiempos y la sabiduría que cada persona ya porta.',
        approachDesc4: 'Cuando es adecuado, se integran palabras, preguntas o reflexiones que ayudan a dar sentido, aliviar la carga interna y acompañar el proceso con mayor claridad y amabilidad, siempre desde un lugar no invasivo.',
        workshopsTitle: '¿Cómo se desarrollan estos workshops?',
        workshopsDesc: 'Los encuentros incluyen propuestas corporales, creativas y simbólicas que permiten acceder al mundo interno de manera intuitiva, sin análisis ni interpretación.',
        workshopsDesc2: 'A través del cuerpo, el símbolo y la experiencia directa, se habilitan procesos de integración que surgen de forma natural cuando el espacio es seguro y está bien sostenido.',
        notForced: 'Nada se fuerza.',
        safePath: 'Cada persona recorre su propio camino dentro de un espacio cuidado, contenido y respetuoso.',
        focusTitle: 'Un enfoque sensible e integrador',
        focusSubtitle: 'El trabajo se orienta a:',
        focusList: [
          'favorecer la conexión con el cuerpo',
          'abrir espacios de escucha interna',
          'permitir que emerja la intuición',
          'facilitar comprensiones profundas sin juicio ni exigencia'
        ],
        invitationTitle: 'Estos workshops son una invitación a soltar el control, la autoexigencia y el rol de "tener que saber", para abrirse a una experiencia más libre, auténtica y presente.',
        forWhomTitle: '¿Para quiénes son estos espacios?',
        forWhomDesc: 'Estos encuentros están pensados para personas que sienten el llamado a:',
        forWhomList: [
        ...
        onlyOpenness: 'Solo apertura, curiosidad y disposición a explorar.',
        finalInvitationTitle: '✨ Invitación',
        ...
        finalInvitationCTA: 'Descubre los próximos encuentros y reserva tu lugar.',
