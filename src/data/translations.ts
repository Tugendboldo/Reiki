...
export const translations = {
  de: {
    ...
    about: {
      ...
      description5: 'Ich begleite aus gelebter Erfahrung, aus kontinuierlicher Praxis und mit einem tiefen Respekt für die individuellen Rhythmen jedes Prozesses.',
      closingText: 'Wenn dich diese Art der Begleitung anspricht, begleite ich dich gerne auf deinem Weg.',
  ...
  es: {
    ...
    about: {
      ...
      description3: 'Mi recorrido con el Reiki ha pasado por diferentes maestros y enfoques, recordándome que existen muchos caminos de sanación y autodescubrimiento. Con el tiempo comprendí que la claridad no llega como una iluminación repentina, sino como un proceso lento y honesto, en el que una se permite mirarse sin filtros y distinguir qué partes de su vida responden a su verdad y cuáles a expectativas externas.',
      description4: 'Desde esa comprensión acompaño hoy: creando espacios donde no es necesario luchar contra lo que se siente, sino escucharlo; donde la pausa, el silencio y la presencia permiten que lo esencial vuelva a ordenarse.',
      description5: 'Si sientes que esta forma de acompañar resuena contigo, estaré encantada de acompañarte en tu proceso.',
      closingText: 'Si este tipo de acompañamiento te resuena, estaré encantada de acompañarte en tu camino.',
