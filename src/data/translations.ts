...
export const translations = {
  ...
  en: {
    ...
    hero: {
      ...
      description: 'Here I accompany personal development processes and training through Reiki Usui Tibetano, traditional Japanese Reiki practices, and experiential offerings that invite you to reconnect with the body, presence, and inner perception. All offerings arise from respect for individual rhythm. No processes are forced – rather, a protected space is created where healing can reveal itself when there is rest, openness, and trust.',
