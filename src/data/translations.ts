...
export const translations = {
  ...
  en: {
    ...
    about: {
      ...
      title: 'About ',
      titleHighlight: 'Me',
      description1: 'My encounter with Reiki was neither random nor singular. Reiki appeared at different stages of my life, particularly during times of deep inner transformation and personal reorientation.',
      description2: 'For more than 12 years, Reiki has been a natural part of my life – both in my own practice and in accompanying processes and sessions with other people. On this path, Reiki has been a reliable companion to which I could always return: a presence that supports, organizes, and assists in a loving, subtle, yet profound way.',
      description3: 'My Reiki path led me through different teachers and approaches and reminded me that there are many paths of healing and self-knowledge. Over time, I understood that clarity does not arise as sudden enlightenment, but as a slow, honest process – a meeting with oneself without filters, to recognize which parts of one\'s life correspond to inner truth and which are external expectations.',
      description4: 'From this understanding, I accompany today: by creating spaces where nothing needs to be fought, but can be heard; spaces where pause, silence, and presence allow the essential to reorganize itself.',
      description5: 'I accompany from lived experience, from continuous practice, and with deep respect for the individual rhythms of each process.',
      closingText: 'If this kind of accompaniment appeals to you, I would be happy to accompany you on your path.',
  ...
  es: {
    ...
    about: {
      ...
      closingText: 'Si sientes que es momento de detenerte y volver a verte con más claridad: te invito a aprovechar este momento para ti. Escríbeme, será un placer conocerte.',
