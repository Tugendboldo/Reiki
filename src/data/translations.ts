...
export const translations = {
  de: {
    ...
    hero: {
      ...
      featuresHeading: 'Alle Angebote entstehen aus demselben Respekt: dem Respekt vor deinem individuellen Rhythmus. Nichts wird hier erzwungen. Es entsteht lediglich ein geschützter Raum – ein Raum, in dem sich Heilung zeigen kann, sobald Ruhe, Offenheit und Vertrauen da sind.',
  ...
  en: {
    ...
    hero: {
      ...
      description: 'Here you´ll find what I offer: individual sessions and trainings in Usui Tibetan Reiki and traditional Japanese Reiki, along with experiential spaces that gently guide you back to your body, your presence, and your inner awareness. Take your time to look around – and discover what resonates with you right now.',
      featuresHeading: 'Every offering comes from the same respect: respect for your individual rhythm. Nothing here is forced. What emerges is simply a protected space – a space where healing can reveal itself, once calm, openness, and trust are present.',
    ...
    approach: {
      ...
      principles: [
        'I accompany you from presence, listening, and respect.',
        'I don´t make diagnoses or interpret health conditions.',
        'My role is to create a safe space — for self-regulation and inner balance.'
      ],
      vision: 'For me, Reiki is a living practice and a path to inner clarity, carried by simplicity, ethics, and transparency. You´ll find it in my individual sessions, group offerings, and trainings.',
      closing: 'Do you have a question about my work, or want to know which path is right for you? Reach out — I´ll respond to you personally.'
    },
    about: {
      badge: 'About Me',
      title: 'About ',
    ...
    contact: {
      ...
      description: 'Reach out for a personal conversation, or book your appointment directly. I´d love to hear from you.',
      phone: 'Phone',
  ...
  es: {
    ...
    hero: {
      ...
      description: 'Aquí encontrarás mis servicios: sesiones individuales y formaciones en Reiki Usui Tibetano y Reiki tradicional japonés, además de espacios vivenciales que te llevan, con suavidad, de vuelta a tu cuerpo, tu presencia y tu percepción interior. Tómate tu tiempo para explorar – y descubre lo que resuena contigo ahora.',
      featuresHeading: 'Todas las propuestas nacen del mismo respeto: el respeto por tu ritmo individual. Aquí nada se fuerza. Solo se crea un espacio protegido – un espacio donde la sanación puede mostrarse, en cuanto la calma, la apertura y la confianza estén presentes.',
    ...
    contact: {
      ...
      description: 'Escríbeme para una conversación personal, o reserva directamente tu cita. Me encantará saber de ti.',
      phone: 'Teléfono',
