...
export const translations = {
  de: {
    ...
    about: {
      ...
      title: 'Über ',
      titleHighlight: 'mich',
      description1: 'Meine Begegnung mit Reiki war weder zufällig noch einmalig. Reiki zeigte sich in verschiedenen Phasen meines Lebens, insbesondere in Zeiten tiefer innerer Wandlung und persönlicher Neuausrichtung.',
  ...
  es: {
    ...
    about: {
      ...
      title: 'Acerca de ',
      titleHighlight: 'mí',
      description1: 'Mi encuentro con Reiki no fue ni casual ni único. Reiki se manifestó en diferentes etapas de mi vida, especialmente en momentos de profunda transformación interna y reorientación personal.',
      description2: 'Desde hace más de 12 años, Reiki es una parte natural de mi vida, tanto en mi propia práctica como en el acompañamiento de procesos y sesiones con otras personas. En este camino, Reiki ha sido un compañero confiable al que siempre pude volver: una presencia que sostiene, ordena y apoya de manera amorosa, sutil y a la vez profunda.',
      description3: 'Mi camino en Reiki me llevó a través de diferentes maestros y enfoques, y me recordó que existen muchos caminos de sanación y autoconocimiento. Con el tiempo comprendí que la claridad no surge como una iluminación repentina, sino como un proceso lento y honesto: un encuentro consigo mismo sin filtros, para reconocer qué partes de la propia vida corresponden a la verdad interior y cuáles son expectativas externas.',
      description4: 'Desde esta comprensión acompaño hoy: creando espacios donde nada debe ser combatido, sino que puede ser escuchado; espacios donde la pausa, el silencio y la presencia permiten que lo esencial se reorganice.',
      description5: 'Acompaño desde la experiencia vivida, desde la práctica continua y con un profundo respeto por los ritmos individuales de cada proceso.',
