            ...
            <div className="space-y-8">
              ...
              <div className="pt-6">
                <button
                  ...
                  className="inline-block bg-gradient-to-r from-cyan-200 via-purple-200 to-pink-200 text-purple-800 px-8 py-4 rounded-full font-semibold hover:from-cyan-300 hover:via-purple-300 hover:to-pink-300 transition-all duration-300 transform hover:scale-105 shadow-md hover:shadow-lg"
                >
          ...
          <div className="mt-12">
            <div className="bg-gradient-to-br from-purple-50 to-pink-50 rounded-3xl p-8">
              ...
              <form className="space-y-6">
                ...
                <button className="w-full bg-gradient-to-r from-cyan-200 via-purple-200 to-pink-200 text-purple-800 py-4 rounded-full font-semibold hover:from-cyan-300 hover:via-purple-300 hover:to-pink-300 transition-all duration-300 transform hover:scale-105 shadow-md hover:shadow-lg">
